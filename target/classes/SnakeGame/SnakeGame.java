...
public class SnakeGame extends JPanel implements ActionListener, KeyListener, Score {
    ...
    public SnakeGame(int lebarPapan, int tinggiPapan, String nama, Player player) {
        this.nama = nama;
        this.player= player;
