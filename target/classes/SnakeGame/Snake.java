...
public class Snake {
    ...
    public Snake(int startX, int startY) {
        ...
        try {
            ...
            headRightImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/head_right_image.png"));
            headLeftImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/head_left_image.png"));
            headUpImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/head_up_image.png"));
            headDownImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/head_down_image.png"));
            bodyImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/body_image.png"));
//            tailImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/tail_image.png"));
            tailRightImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/tail_right_image.png"));
            tailLeftImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/tail_left_image.png"));
            tailUpImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/tail_up_image.png"));
            tailDownImage = ImageIO.read(classLoader.getResourceAsStream("SnakeGame/tail_down_image.png"));
