...
public class StatsView extends BackButton {
    ...
    public void updateData() {
        totalScore.setText(String.valueOf(player.getHighScore()));
        jmlWinSuit.setText(String.valueOf(player.getWinSuit()));
        jmlLoseSuit.setText(String.valueOf(player.getLoseSuit()));
        jmlDrawSuit.setText(String.valueOf(player.getDrawSuit()));
        jmlWinTTT.setText(String.valueOf(player.getWinTicTacToe()));
        jmlLoseTTT.setText(String.valueOf(player.getLoseTicTacToe()));
        jmlDrawTTT.setText(String.valueOf(player.getDrawTicTacToe()));
    }
