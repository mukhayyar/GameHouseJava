...
public class HowToPlayView extends BaseView {
     ...
     */
    public HowToPlayView(Player player) {
        initComponents();
        lblJudul.setText("HOW TO PLAY");
        addClickListener(btnSnake, () -> FrameNavigator.switchToFrame(this, new SnakeHTP(player)));
        addClickListener(btnSuit, () -> FrameNavigator.switchToFrame(this, new SuitHTP(player)));
        addClickListener(btnTicTacToe, () -> FrameNavigator.switchToFrame(this, new TicTacToeHTP(player)));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HowToPlayView(new Player("bagas")).setVisible(true);
            }
        });
    }
