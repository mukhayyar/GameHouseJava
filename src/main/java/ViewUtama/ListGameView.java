...
public class ListGameView extends BaseView{
    ...
    public ListGameView() {
        ...
        addClickListener(btnSnake, () -> FrameNavigator.switchToFrame(this, new Home("Tsaqif")));
        addClickListener(btnSuit, () -> FrameNavigator.switchToFrame(this, new SuitGame_View()));
        addClickListener(btnTicTacToe, () -> FrameNavigator.switchToFrame(this, new MainTicTacToe()));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListGameView().setVisible(true);
            }
        });
    }
